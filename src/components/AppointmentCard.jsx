...
const AppointmentCard = ({
  ...
  const specialty =
    doctorSpecialties[doctorName] || "GENERAL_PRACTITIONER";
  ...
  return (
    <div style={styles.card}>
      ...
      <div style={styles.row}>
        ...
        <div>
          <b>{patientName}</b>
          <div style={styles.small}>Patient</div>
        </div>
      </div>
      ...
      <div style={styles.actions}>
        {onEdit && (
          <button style={styles.edit} onClick={() => onEdit(appt)}>
            Edit
          </button>
        )}

        {onDelete && (
          <button style={styles.delete} onClick={() => onDelete(appt)}>
            Delete
          </button>
        )}

        {onCancel && (
          <button style={styles.cancel} onClick={() => onCancel(appt)}>
            Cancel
          </button>
        )}

        {onComplete && (
          <button style={styles.complete} onClick={() => onComplete(appt)}>
            Complete
          </button>
        )}
      </div>
