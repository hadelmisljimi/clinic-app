            ...
            {[
              {
                ...
                desc: "Primary healthcare, diagnosis and preventive care for all patients.",
              },
              {
                title: "Cardiologist",
                desc: "Heart disease diagnosis, treatment and cardiovascular monitoring.",
              },
              {
                title: "Neurologist",
                desc: "Brain, nerve and spinal cord disorders treatment and diagnostics.",
              },
              {
                title: "Orthopedic Surgeon",
                desc: "Bone, joint and musculoskeletal system treatment and surgery.",
              },
              {
                title: "Pediatrician",
              ...
              },
              {
                ...
                desc: "Treatment of ear, nose and throat conditions and infections.",
              },
            ].map((item, i) => (
              <CCol lg={4} md={6} key={i}>
